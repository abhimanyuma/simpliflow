...
export default class TextAreaComponentContainer extends React.Component {
    ...
    return(
      <div className={"form-group row " + error_class}>
        ...
        <div className="col-sm-8">
          <textarea type="text" defaultValue={this.get_value()} className="form-control" ref="text" placeholder={this.props.config["placeholder"] || ""} onInput={e=>{this.on_change(e)}}>
